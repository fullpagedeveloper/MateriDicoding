package com.fullpagedeveloper.myalarmmanager
    ...
    override fun onClick(view: View) {
        when(view.id) {
            ...
            R.id.btn_set_one_time_alarm -> {
                ...
                val onMessage = edt_once_message.text.toString()

                alarmReceiver.setOneTimeAlarm(this, AlarmReceiver.TYPE_ONE_TIME, onceDate, onceTime, onMessage)
            }
